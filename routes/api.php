...
Route::get('/koleksiExport', [KoleksiController::class, 'koleksiExport']);
...
Route::get('/kartumuseumExport', [KartuMuseumController::class, 'kartumuseumExport']);
...
Route::get('/kartuinventarisExport', [KartuInvController::class, 'kartuinventarisExport']);
...
Route::get('/kartusimpanExport', [KartuSimpanController::class, 'kartusimpanExport']);
...
Route::get('/karturegistrasiExport', [KartuRegistrasiController::class, 'karturegistrasiExport']);
